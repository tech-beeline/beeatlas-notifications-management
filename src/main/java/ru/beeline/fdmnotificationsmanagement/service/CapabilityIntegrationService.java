...
import static ru.beeline.fdmnotificationsmanagement.utils.RestHelper.getRestTemplate;

@Slf4j
@Service
public class CapabilityIntegrationService {

    private final String capabilityServerUrl;

    public CapabilityIntegrationService(@Value("${integration.capability-server-url}") String capabilityServerUrl) {
